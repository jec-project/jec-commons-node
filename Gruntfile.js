/*!
 * JEC Node.js Commons Gruntfile.js
...
/*
 * Provides tasks for building and testing the jec-commons-node project.
 */
module.exports = function(grunt) {
  ...
  grunt.config("typedoc", {
    doc: {
      ...
      options: {
        ...
        readme: "README.md",
        name: "JEC Node.js Commons Project",
        exclude: "**/*Test*.ts"
      }
    }
  });
  ...
  //--> Task: builds the "jec-commons-node" project:
  grunt.registerTask("build", ["ts:build", "copy:main",
                               "copy:initTypes", "copy:buildTypesFile",
                               "clean:build"]);

  //--> Task: builds the "jec-commons-node" API documentation:
